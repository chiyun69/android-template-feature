...
import com.example.modules.template_feature.di.DatabaseModule_ProvideDaoFactory;
import com.example.modules.template_feature.di.DatabaseModule_ProvideDatabaseFactory;
import com.example.modules.template_feature.di.DatabaseModule_ProvidePreferencesFactory;
import com.example.modules.template_feature.di.NetworkModule_ProvideApiServiceFactory;
import com.example.modules.template_feature.di.NetworkModule_ProvideHttpLoggingInterceptorFactory;
import com.example.modules.template_feature.di.NetworkModule_ProvideJsonFactory;
import com.example.modules.template_feature.di.NetworkModule_ProvideOkHttpClientFactory;
import com.example.modules.template_feature.di.NetworkModule_ProvideRetrofitFactory;
import com.example.modules.template_feature.di.RepositoryModule_ProvideTemplateFeatureRepositoryFactory;
import com.example.modules.template_feature.di.UseCaseModule_ProvideGetTemplateFeatureDataUseCaseFactory;
import com.example.modules.template_feature.di.UseCaseModule_ProvideSaveTemplateFeatureDataUseCaseFactory;
import com.example.modules.template_feature.di.UseCaseModule_ProvideSyncTemplateFeatureUseCaseFactory;
...
import com.example.modules.template_feature.presentation.screens.detail.DetailViewModel;
import com.example.modules.template_feature.presentation.screens.detail.DetailViewModel_HiltModules;
import com.example.modules.template_feature.presentation.screens.detail.DetailViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.example.modules.template_feature.presentation.screens.detail.DetailViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.example.modules.template_feature.presentation.screens.main.MainViewModel;
import com.example.modules.template_feature.presentation.screens.main.MainViewModel_HiltModules;
import com.example.modules.template_feature.presentation.screens.main.MainViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.example.modules.template_feature.presentation.screens.main.MainViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerSampleApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends SampleApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(2).put(DetailViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, DetailViewModel_HiltModules.KeyModule.provide()).put(MainViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, MainViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends SampleApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(2).put(DetailViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (detailViewModelProvider))).put(MainViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (mainViewModelProvider))).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.modules.template_feature.presentation.screens.detail.DetailViewModel
          return (T) new DetailViewModel(singletonCImpl.getTemplateFeatureDataUseCase(), singletonCImpl.saveTemplateFeatureDataUseCase());

          case 1: // com.example.modules.template_feature.presentation.screens.main.MainViewModel
          return (T) new MainViewModel(singletonCImpl.getTemplateFeatureDataUseCase(), singletonCImpl.saveTemplateFeatureDataUseCase(), singletonCImpl.syncTemplateFeatureUseCase());
  ...
  private static final class SingletonCImpl extends SampleApplication_HiltComponents.SingletonC {
    ...
    Provider<TemplateFeatureApiService> provideApiServiceProvider;

    Provider<TemplateFeatureDatabase> provideDatabaseProvider;

    Provider<TemplateFeaturePreferences> providePreferencesProvider;

    Provider<TemplateFeatureRepository> provideTemplateFeatureRepositoryProvider;
    ...
    TemplateFeatureDao templateFeatureDao() {
    ...
    GetTemplateFeatureDataUseCase getTemplateFeatureDataUseCase() {
      return UseCaseModule_ProvideGetTemplateFeatureDataUseCaseFactory.provideGetTemplateFeatureDataUseCase(provideTemplateFeatureRepositoryProvider.get());
    }

    SaveTemplateFeatureDataUseCase saveTemplateFeatureDataUseCase() {
      return UseCaseModule_ProvideSaveTemplateFeatureDataUseCaseFactory.provideSaveTemplateFeatureDataUseCase(provideTemplateFeatureRepositoryProvider.get());
    }

    SyncTemplateFeatureUseCase syncTemplateFeatureUseCase() {
      return UseCaseModule_ProvideSyncTemplateFeatureUseCaseFactory.provideSyncTemplateFeatureUseCase(provideTemplateFeatureRepositoryProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<TemplateFeatureApiService>(singletonCImpl, 1));
      this.provideDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<TemplateFeatureDatabase>(singletonCImpl, 6));
      this.providePreferencesProvider = DoubleCheck.provider(new SwitchingProvider<TemplateFeaturePreferences>(singletonCImpl, 7));
      this.provideTemplateFeatureRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<TemplateFeatureRepository>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.modules.template_feature.domain.repositories.TemplateFeatureRepository
          return (T) RepositoryModule_ProvideTemplateFeatureRepositoryFactory.provideTemplateFeatureRepository(singletonCImpl.provideApiServiceProvider.get(), singletonCImpl.templateFeatureDao(), singletonCImpl.providePreferencesProvider.get());

          case 1: // com.example.modules.template_feature.data.remotedatasource.api.TemplateFeatureApiService
          ...
          case 6: // com.example.modules.template_feature.data.localdatasource.database.TemplateFeatureDatabase
          return (T) DatabaseModule_ProvideDatabaseFactory.provideDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 7: // com.example.modules.template_feature.data.localdatasource.preferences.TemplateFeaturePreferences
